...
const LinkHamburgerNonBottomCont: NextPage<LinkHamburgerNonBottomContType> = ({
  ...
  return (
    <div className="box-border w-[340px] flex flex-row items-center justify-center py-[50px] px-0 text-center text-21xl text-black font-body-medium border-b-[1px] border-solid border-black">
